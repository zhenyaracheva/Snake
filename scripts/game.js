var game = (function () {
    ...
    function isHitWall(x, y) {
        if (10 > x - CONSTANTS.START_CANVAS_X || x + CONSTANTS.HIT_WALL_MAX_VALUE > canvas.width ||
            5 > y - CONSTANTS.HIT_WALL_MAX_VALUE || (y + CONSTANTS.HIT_WALL_MIN_VALUE+5) > canvas.height) {
            return true;
        }
